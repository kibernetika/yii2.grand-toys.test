...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['username', 'unique', 'message' => 'Use another name!'],
            ['email', 'unique', 'message' => 'This email using!'],
            ['secret_key', 'unique']
        ];
    }
    /**
    ...
    public function generateSecretKey()
    {
        try {
            ...
            throw new NotSupportedException('Oops something wrong!');
        }
    }
